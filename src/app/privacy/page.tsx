        ...
        <div className="glass-card p-6 md:p-16 text-center shadow-2xl border border-[var(--glass-border)] rounded-[30px] md:rounded-[40px] bg-opacity-70 backdrop-blur-xl overflow-hidden">
          ...
          <div className="space-y-8 md:space-y-12 text-base md:text-xl leading-[1.8] md:leading-[2] text-center max-w-4xl mx-auto px-2 md:px-0">
            <section className="bg-white bg-opacity-5 p-5 md:p-8 rounded-2xl md:rounded-3xl border border-white border-opacity-10 shadow-inner">
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 border-b border-[var(--uae-gold)] pb-2 inline-block">أولاً: المقدمة</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">ثانياً: نطاق التطبيق</h2>
              <p>
            ...
            <section className="bg-[var(--uae-green)] bg-opacity-5 p-5 md:p-8 rounded-2xl md:rounded-3xl">
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">ثالثاً: أنواع البيانات التي نقوم بجمعها</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">رابعاً: ملفات تعريف الارتباط (Cookies) – شرح تفصيلي</h2>
              <p>
            ...
            <section className="bg-[var(--uae-red)] bg-opacity-5 p-5 md:p-8 rounded-2xl md:rounded-3xl">
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">خامساً: سياسة الإعلانات والطرف الثالث</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">سادساً: حقوق الطالب وولي الأمر</h2>
              <p>
            ...
            <section className="pt-8 md:pt-10 border-t border-[var(--glass-border)]">
              <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">عاشراً: التواصل معنا</h2>
              <p className="mb-6">
